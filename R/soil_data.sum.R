...
data.sum = function(data,transect){
  ...
  data2 = subset(data1,select=c("Point","Carbon.0.10.survey", "Carbon.10.40.survey",
                                "Bulk.Density.survey", "Infilt1.survey","Carbon010change",
                                "Carbon1040change","Bulk.density.change"))
  } else {data2 = subset(data1, select = c("Point", "Carbon.0.10.survey2", "Carbon.10.40.survey2",
